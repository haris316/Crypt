...
const home = (navigation) => {
  const categoryIcons = [
    <TouchableOpacity><Icon name="favorite" size={25} color="purple" /></TouchableOpacity>,
    <TouchableOpacity><Icon name="check-circle" size={25} color="purple" /></TouchableOpacity>,
    <TouchableOpacity><Icon name="category" size={25} color="purple" /></TouchableOpacity>,
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FFF" }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <View>
            {/* <Text style={style.headerTitle}>Videos</Text> */}
